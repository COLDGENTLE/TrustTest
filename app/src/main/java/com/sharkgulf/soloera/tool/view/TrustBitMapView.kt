...
class TrustBitMapView  @JvmOverloads constructor(
    ...
    fun setRadius(radius: Float): TrustBitMapView {
        this.radius = radius
    ...
    fun setMaskColor(@ColorInt maskColor: Int): TrustBitMapView {
    ...
    fun setBgColor(bgColor: Int): TrustBitMapView {
    ...
    fun setBorderColor(@ColorInt borderColor: Int): TrustBitMapView {
    ...
    fun setMaxScale(maxScale: Float): TrustBitMapView {
    ...
    fun setDoubleClickScale(doubleClickScale: Float): TrustBitMapView {
    ...
    private fun init() {
        ...
        showBitmap?.width = getWidth()
        showBitmap?.height = getHeight()
...
//            initTranslateY = ((getHeight() - showBitmap!!.getHeight()) / 2).toFloat()
    ...
    @Deprecated("")
    fun setBitmap(bitmap: Bitmap): TrustBitMapView {
        showBitmap = bitmap
        resetBitmap()
        return this
    }
    ...
    /** */
    fun setBitmap(resId: Int, reqWidth: Int, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmap(getContext(), resId, reqWidth, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmap(pathName: String, reqWidth: Int, reqHeight: Int): TrustBitMapView {
    ...
    @Deprecated("")
    fun setBitmapToRotate(pathName: String, reqWidth: Int, reqHeight: Int): TrustBitMapView {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmap(pathName, reqWidth, reqHeight)
        resetBitmap()
    ...
    fun setBitmap(data: ByteArray, offset: Int, length: Int, reqWidth: Int, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmap(data, offset, length, reqWidth, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmap(fd: FileDescriptor, outPadding: Rect, reqWidth: Int, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmap(fd, outPadding, reqWidth, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmap(res: Resources, value: TypedValue, `is`: InputStream, pad: Rect, reqWidth: Int, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmap(res, value, `is`, pad, reqWidth, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmap(`is`: InputStream, outPadding: Rect, reqWidth: Int, reqHeight: Int): TrustBitMapView {
    ...
    /** */
    fun setBitmapForHeight(resId: Int, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForHeight(getContext(), resId, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmapForHeight(pathName: String, reqHeight: Int): TrustBitMapView {
    ...
    @Deprecated("")
    fun setBitmapForHeightToRotate(pathName: String, reqHeight: Int): TrustBitMapView {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForHeight(pathName, reqHeight)
        resetBitmap()
        //        int degree = CropViewUtils.readPictureDegree(pathName);
    ...
    fun setBitmapForHeight(data: ByteArray, offset: Int, length: Int, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForHeight(data, offset, length, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmapForHeight(fd: FileDescriptor, outPadding: Rect, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForHeight(fd, outPadding, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmapForHeight(res: Resources, value: TypedValue, `is`: InputStream, pad: Rect, reqHeight: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForHeight(res, value, `is`, pad, reqHeight)
        resetBitmap()
        return this
    }

    fun setBitmapForHeight(`is`: InputStream, outPadding: Rect, reqHeight: Int): TrustBitMapView {
    ...
    /** */
    fun setBitmapForWidth(resId: Int, reqWidth: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForWidth(getContext(), resId, reqWidth)
        resetBitmap()
        return this
    }

    fun setBitmapForWidth(pathName: String, reqWidth: Int): TrustBitMapView {
    ...
    @Deprecated("")
    fun setBitmapForWidthToRotate(pathName: String, reqWidth: Int): TrustBitMapView {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForWidth(pathName, reqWidth)
        resetBitmap()
        //        int degree = CropViewUtils.readPictureDegree(pathName);
    ...
    fun setBitmapForWidth(data: ByteArray, offset: Int, length: Int, reqWidth: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForWidth(data, offset, length, reqWidth)
        resetBitmap()
        return this
    }

    fun setBitmapForWidth(fd: FileDescriptor, outPadding: Rect, reqWidth: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForWidth(fd, outPadding, reqWidth)
        resetBitmap()
        return this
    }

    fun setBitmapForWidth(res: Resources, value: TypedValue, `is`: InputStream, pad: Rect, reqWidth: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForWidth(res, value, `is`, pad, reqWidth)
        resetBitmap()
        return this
    }

    fun setBitmapForWidth(`is`: InputStream, outPadding: Rect, reqWidth: Int): TrustBitMapView {
    ...
    /** */
    fun setBitmapForScale(resId: Int, scaleSize: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForScale(getContext(), resId, scaleSize)
        resetBitmap()
        return this
    }

    fun setBitmapForScale(pathName: String, scaleSize: Int): TrustBitMapView {
    ...
    @Deprecated("")
    fun setBitmapForScaleToRotate(pathName: String, scaleSize: Int): TrustBitMapView {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForScale(pathName, scaleSize)
        resetBitmap()
        //        int degree = CropViewUtils.readPictureDegree(pathName);
    ...
    fun setBitmapForScale(data: ByteArray, offset: Int, length: Int, scaleSize: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForScale(data, offset, length, scaleSize)
        resetBitmap()
        return this
    }

    fun setBitmapForScale(fd: FileDescriptor, outPadding: Rect, scaleSize: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForScale(fd, outPadding, scaleSize)
        resetBitmap()
        return this
    }

    fun setBitmapForScale(res: Resources, value: TypedValue, `is`: InputStream, pad: Rect, scaleSize: Int): TrustBitMapView {
        showBitmap = CropViewUtils.compressBitmapForScale(res, value, `is`, pad, scaleSize)
        resetBitmap()
        return this
    }

    fun setBitmapForScale(`is`: InputStream, outPadding: Rect, scaleSize: Int): TrustBitMapView {
