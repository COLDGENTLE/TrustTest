...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mMaxValue = typedArray.getFloat(R.styleable.WaveProgress_maxValue, 160);
        ...
        mValueColor = typedArray.getColor(R.styleable.WaveProgress_valueColor, Color.TRANSPARENT);

        mHint = typedArray.getString(R.styleable.WaveProgress_hint);
        mHintColor = typedArray.getColor(R.styleable.WaveProgress_hintColor, Color.TRANSPARENT);
        ...
        mCircleColor = typedArray.getColor(R.styleable.WaveProgress_circleColor, Color.TRANSPARENT);
