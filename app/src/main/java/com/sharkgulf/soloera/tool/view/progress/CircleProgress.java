...
import com.sharkgulf.soloera.tool.view.progress.utils.Constant;
import com.sharkgulf.soloera.tool.view.progress.utils.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {PublicMangerKt.getBsColor(R.color.colorWhiteGay),PublicMangerKt.getBsColor(R.color.colorWhiteGay), PublicMangerKt.getBsColor(R.color.colorWhiteGay)};
    //当前进度，[0.0f,1.0f]
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mHintColor = typedArray.getColor(R.styleable.CircleProgressBar_hintColor, Color.TRANSPARENT);
        ...
        mValueColor = typedArray.getColor(R.styleable.CircleProgressBar_valueColor, Color.TRANSPARENT);
    ...
    private void drawArc(Canvas canvas) {
        ...
        Log.d("lhh"," mRectF.centerX();" +  mRectF.centerX() + "| mRectF.centerY():"+mRectF.centerY() + " | currentAngle :"+currentAngle);
//        canvas.drawBitmap(mBitmap, 0, 0, null);

//        Rect dst = new Rect(mBitmap.getWidth()/2,0,mBitmap.getWidth()/2,mBitmap.getHeight()/2);
