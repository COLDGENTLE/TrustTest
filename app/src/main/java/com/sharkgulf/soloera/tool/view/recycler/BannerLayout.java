package com.sharkgulf.soloera.tool.view.recycler;
...
import com.sharkgulf.soloera.tool.view.recycler.layoutmanager.BannerLayoutManager;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        itemSpace = a.getInt(R.styleable.BannerLayout_itemSpace1, 20);
...
//        }
    ...
    public int submintPosition(){
        TrustLogUtils.d("mLayoutManager.getCurrentPosition(): "+mLayoutManager.getCurrentPosition());
//        TrustLogUtils.d("mLayoutManager.getOffsetToCenter(): "+mLayoutManager.getOffsetToCenter());
