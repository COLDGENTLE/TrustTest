...
public class TrustRetrofitCreator {
    ...
    private static TrustServiceHodler trustServiceHodler = new TrustServiceHodler();

    private static final class  TrustServiceHodler{
        private  static   TrustService TRUST_SERVICE = null;
        private  static TrustService TRUST_SERVICE_SSL = null;
        private  static TrustService TRUST_SERVICE_SSL_TRUST_ALL = null;

        public  TrustService getTrustService(){
            if (TRUST_SERVICE == null) {
                TRUST_SERVICE = RetrofitHolder.RETROFIT_CLIENT.create(TrustService.class);
            }
            return TRUST_SERVICE;
        }

        public  TrustService getTrustServiceSSL(){
            if (TRUST_SERVICE_SSL == null) {
                TRUST_SERVICE_SSL = RetrofitHolder.getRetrofitClient(false).create(TrustService.class);
            }
            return TRUST_SERVICE_SSL;
        }

        public  TrustService getTrustServiceSSLTrustAll(){
            if (TRUST_SERVICE_SSL_TRUST_ALL == null) {
                TRUST_SERVICE_SSL_TRUST_ALL = RetrofitHolder.getRetrofitClient(true).create(TrustService.class);
            }
            return TRUST_SERVICE_SSL_TRUST_ALL;
        }
    }

    public  TrustService getTrustService(){return trustServiceHodler.getTrustService();}
    public  TrustService getTrustServiceSSL(){return trustServiceHodler.getTrustServiceSSL();}
    public  TrustService getTrustServiceSSLTrustAll(){return trustServiceHodler.getTrustServiceSSLTrustAll();}
