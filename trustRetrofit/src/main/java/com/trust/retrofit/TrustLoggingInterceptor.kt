 ...
 *
 */
class TrustLoggingInterceptor (trustRetrofit :TrustRetrofit): Interceptor {
    private val TAG = "http info"
    private val mTrustRetrofit = trustRetrofit
    ...
    private fun addToken(headers: Headers){
