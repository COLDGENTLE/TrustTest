 ...
 *
 */
class TrustRetrofit (context: Context ,isSSL :Boolean = false, baseUrl: String){
    ...
    companion  object {
        ...
        fun create(context:Context,baseUrl: String,isSSL: Boolean = false,fileName: String,pwd:String) : TrustRetrofit {
            if (trustRetrofit == null) {
