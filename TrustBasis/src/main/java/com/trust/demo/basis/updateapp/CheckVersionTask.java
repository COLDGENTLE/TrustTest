...
public class CheckVersionTask implements Runnable {
    ...
    public CheckVersionTask(Context context ,String authoritiesName ,String localVersion , UpdataInfo info ) {
        ...
        new Thread()
        {
            ...
            public void run() {
                ...
                try {
                    ...
                    File file = DownLoadManager.getFileFromServer(info.getUrl(), pd,context);
