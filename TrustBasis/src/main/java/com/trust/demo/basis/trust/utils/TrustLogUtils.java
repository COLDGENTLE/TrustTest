...
public class TrustLogUtils {
    ...
    public static void configLog(String content) {
        if (!allowConfig) {
            return;
        }
    ...
    public static void d(String tag,String content) {
        ...
        StackTraceElement caller = getCallerStackTraceElement();
        String tag1 = generateTag(caller);
        if (customLogger != null) {
            customLogger.d(tag1 + tag, content);
        } else {
            Log.d(tag1+tag, content);
        }
    }
    ...
    public static void e(String content, String e) {
        if (!allowE) {
            return;
        }
        ...
        if (customLogger != null) {
            customLogger.e(tag, content, new Throwable(e));
        } else {
            Log.e(tag, content, new Throwable(e));
        }
        if (isSaveLog) {
            point(LOG_PATH, tag, new Throwable(e).getMessage());
        }
    }
    ...
    public static void setIsDebug(boolean isDebug){
        TrustLogUtils.allowConfig = isDebug;
        TrustLogUtils.allowD = isDebug;
        TrustLogUtils.allowE = isDebug;
        TrustLogUtils.allowI = isDebug;
        TrustLogUtils.allowV = isDebug;
        TrustLogUtils.allowW = isDebug;
        TrustLogUtils.allowWtf = isDebug;
    }
}
