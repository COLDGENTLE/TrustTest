...
public abstract class TrustHttpRequestModel {
    protected int type = TRUST_RETROFIT_SSL_TRUST_ALL;
    ...
    public abstract <T> void requestUpload(String url, int paramsType,HashMap<String,Object> params, RequestResultListener<T> requestResultListener , Class<T> clasz);
    public abstract <T> void download(String url, long range,String header,  HashMap<String, Object> params, RequestResultListener.DownLoadListener downLoadListener);
